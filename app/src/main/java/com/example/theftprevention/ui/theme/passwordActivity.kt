    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonSubmit.setOnClickListener {
            ...
            if (entered == savedPassword) {
                ...
                // استفاده از همون SharedPreferences که در MainActivity استفاده میشه
                val settingsPrefs = getSharedPreferences("MyPrefs", Context.MODE_PRIVATE)
